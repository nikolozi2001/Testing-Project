const r3 = Number(row["c13_dsrq3"]) || 0;
const r4 = Number(row["c13_dsrk4"]) || 0;
const r5 = Number(row["c13_dwaq5"]) || 0;
const r6 = Number(row["c13_dwaq6"]) || 0;
...
if (r3 < r4) {
  ...
  valid = "რადგან სვეტი 3 და 4 მეტია 0-ზე, სვეტი 5 და 6-იც აუცილებლად მეტი უნდა იყოს 0-ზე";
} else if (r3 === r4 && r5 !== r6) {
  valid =
