...
municipalitiesEn.forEach((municipality, index) => {
  const municipalityKey = municipality.name; // e.g., "batumi"
  const kaMunicipalityName = municipalitiesKa[index].name; // Corresponding name in Georgian

  linkData.forlinks[municipalityKey] = {
    ka: `/regions/municipal/მოსახლეობის%20აღწერა%20წინასწარი/მოსახლეობა%20სქესის%20მიხედვით/აჭარა%20ა.რ/${kaMunicipalityName}.xlsx`,
    en: `/regions/municipal/ENG/Population%20census%20pre/number%20of%20population%20by%20sex/Adjara%20A.R/${municipality.name}.xlsx`,
  };
